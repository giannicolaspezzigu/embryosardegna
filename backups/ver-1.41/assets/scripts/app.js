(function () {
  ...
  async function init() {
    ...
    if (app.ui && typeof app.ui.beginAppLoading === "function") {
      app.ui.beginAppLoading({
        progress: 12,
        message: "Verifica accessi e profilo clinica...",
      });
    } else if (app.ui && typeof app.ui.syncBootLoadingFromStorage === "function") {
